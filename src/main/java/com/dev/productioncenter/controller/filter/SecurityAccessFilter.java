...
public class SecurityAccessFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        accessibleCommands.put(USER, List.of(GO_TO_HOME, GO_TO_COURSES, GO_TO_COURSE_INFO, GO_TO_ACCOUNT,
                GO_TO_UPDATE_ACCOUNT_DATA, GO_TO_ACTIVITIES, GO_TO_ENROLL_ON_COURSE, GO_TO_TIMETABLE, GO_TO_CONTACTS,
                SEARCH_COURSES, CHANGE_LOCALE, SIGN_OUT, UPDATE_ACCOUNT_DATA, REPLENISH_BALANCE, UPLOAD_PROFILE_PICTURE,
                ENROLL_ON_COURSE, DEFAULT));
