        ...
        <div>
            ...
            <div id="authent">
                <input type="text" name="login"
                       ...
                       pattern="[a-zA-Z][A-Za-z0-9]{4,29}" autocomplete="off" value="<c:out value="${sessionScope.user.login}"/>"
            ...
            <div id="personal">
                <input type="text" name="surname"
                       ...
                       pattern="[А-ЯA-Z][а-яa-z]{1,20}" autocomplete="off" value="<c:out value="${sessionScope.user.surname}"/>"
                       title="<fmt:message key="sign_up.surname.title"/>"><br/>
                <input type="text" name="name"
                       placeholder="<fmt:message key="sign_up.name.placeholder"/>"
                       pattern="[А-ЯA-Z][а-яёa-z]{1,15}" autocomplete="off" value="<c:out value="${sessionScope.user.name}"/>"
                       title="<fmt:message key="sign_up.name.title"/>"><br/>
                <input type="email" name="email" placeholder="Email" value="<c:out value="${sessionScope.user.email}"/>"
                ...
                <input type="tel" name="number"
                       ...
                       value="<c:out value="${sessionScope.number}"/>" pattern="\+375\(\d{2}\)\d{3}-\d{2}-\d{2}"
