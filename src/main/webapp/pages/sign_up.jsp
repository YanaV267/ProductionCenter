    ...
    <form id="reg" method="post" action="${pageContext.request.contextPath}/controller?command=sign_up">
        <div id="page1">
            ...
            <input type="password" name="password" required
                   ...
                   pattern="[a-zA-Z][A-Za-z0-9]{7,29}" value="<c:out value="${requestScope.user.password}"/>"
            ...
            <input type="password" name="repeated_password" required
                   ...
                   pattern="[a-zA-Z][A-Za-z0-9]{7,29}" value="<c:out value="${requestScope.user.repeated_password}"/>"
                   title="<fmt:message key="sign_in.password.title"/>"><br/>
            <div id="next">
        ...
        <div id="page2">
            ...
            <input type="text" name="surname" required
                   placeholder="<fmt:message key="sign_up.surname.placeholder"/>" autocomplete="off"
                   pattern="[А-ЯA-Z][а-яa-z]{1,20}" value="<c:out value="${requestScope.user.surname}"/>"
            ...
            <input type="tel" name="number" required placeholder="+375(xx)xxx-xx-xx" autocomplete="off"
                   value="<c:out value="${requestScope.user.number}"/>" pattern="\+375\(\d{2}\)\d{3}-\d{2}-\d{2}"
